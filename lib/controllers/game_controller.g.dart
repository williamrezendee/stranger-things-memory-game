...
mixin _$GameController on GameControllerBase, Store {
  Computed<bool>? _$completeGamePlayComputed;

  @override
  bool get completeGamePlay => (_$completeGamePlayComputed ??= Computed<bool>(
          () => super.completeGamePlay,
          name: 'GameControllerBase.completeGamePlay'))
      .value;
...
won: ${won},
lost: ${lost},
completeGamePlay: ${completeGamePlay}
    ''';
  }
}
